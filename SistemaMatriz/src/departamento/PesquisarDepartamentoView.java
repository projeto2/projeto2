...
import filial.FilialController;

public class PesquisarDepartamentoView extends JDialog
{
	...
	public PesquisarDepartamentoView(JFrame parent)
	{
		super(parent, "Pesquisar Departamento", true);
	...
	public void inicializar(SistemaView s)
	{
		...
		buscar.addActionListener(new DepartamentoController(this,s));
		...
		alterar.addActionListener(new DepartamentoController(this,s));
	}
